...
CREATE TABLE EVENTO(
    ...
    GENERO CHAR(1),
    TIPO VARCHAR(30),
    CONSTRAINT TIPO_EVENTO_INVALIDO CHECK(TIPO = '60M' OR TIPO = '60MB' OR TIPO = '100M' OR TIPO = '100MB' OR TIPO = '110MB' OR TIPO = '200M' OR TIPO = '300M' OR TIPO = '300MB' OR TIPO = '400M' OR TIPO = '400MB' OR TIPO = '800M' OR TIPO = '1000M' OR TIPO = '1500M' OR TIPO = '3000M' OR TIPO = '3000MO' OR TIPO = '5000M' OR TIPO = '10000M' OR TIPO = '50KmM' OR TIPO = '20KmM' OR TIPO = 'MARATONA' OR TIPO = 'COMPRIMENTO' OR TIPO = 'ALTURA' OR TIPO = 'VARA' OR TIPO = 'TRIPLO' OR TIPO = 'PESO' OR TIPO = 'DISCO' OR TIPO = 'DARDO' OR TIPO = 'MARTELO' OR TIPO = 'DECATLO' OR TIPO = 'HEPTATLO' OR TIPO = 'PENTATLO' OR TIPO = 'TRIATLO')
);
